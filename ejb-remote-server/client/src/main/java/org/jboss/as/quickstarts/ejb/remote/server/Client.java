 ...
 */
package org.jboss.as.quickstarts.ejb.remote.server;
...
import org.jboss.as.quickstarts.ejb.remote.server.app.RemoteCalculatorCaller;
...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        p.put("remote.connection.one.port", port);
        ...
        final String rcal = "ejb:jboss-ejb-remote-server/ejb//RemoteCalculatorCallerBean!" + RemoteCalculatorCaller.class.getName();
        final RemoteCalculatorCaller remote = (RemoteCalculatorCaller) context.lookup(rcal);
        remote.invokeRemoteCalculator();
        System.out.println("Invoke RemoteCalculator succeed");
    }
